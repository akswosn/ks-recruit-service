...
@Entity
@Table(name = "member_certificate", schema = "recruit_db", catalog = "")
open class MemberCertificateEntity(
    @Id
    ...
    open var issueAuthority: String? = null,

    @Column(name = "authority_ym")
    open var authorityYm: String? = null,
